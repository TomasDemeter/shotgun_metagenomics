...
rule FastQC:
    ...
    output:
        html_1        = WORKING_DIR + "FastQC/{ERR}_1_fastqc.html",
        zip_file_1    = WORKING_DIR + "FastQC/{ERR}_1_fastqc.zip",
        html_2        = WORKING_DIR + "FastQC/{ERR}_2_fastqc.html",
        zip_file_2    = WORKING_DIR + "FastQC/{ERR}_2_fastqc.zip"        
    params:
