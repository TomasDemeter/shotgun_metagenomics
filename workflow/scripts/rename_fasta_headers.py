...
domains = ['bacteria','archaea'] # changes required
accession = []

for dom in domains:
    dom = pd.read_csv(dom+'_assembly_summary.txt', index_col=0, header=1, sep='\t')
...
genome_folder = '../inputs/genomes/kraken2/kraken2_custom/downloaded_genomes/' # changes required
new_folder = '../inputs/genomes/kraken2/kraken2_custom/fasta_renamed/' # changes required
